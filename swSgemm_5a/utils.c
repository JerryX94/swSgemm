...
void _local_gemm_rrr(const float* A, const int LDA, const float* B, const int LDB, \
...
void _local_gemm_rcr(const float* A, const int LDA, const float* B, const int LDB, \
                     float* C, const int LDC, int M, int N, int K)
{
	for (int i = 0; i < M; i++)
		for (int j = 0; j < N; j++)
